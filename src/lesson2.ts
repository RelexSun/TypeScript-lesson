...
// ----------------------------------------------------
// --------------- Exercies --------------------
// TODO: Given the data below, define a type alias for representing users.
type Users = {
  name: string;
  age: number;
  occupation?: string;
...
// TODO: Birds fly. Fish swim. A Pet can be a Bird or Fish. Use type aliases to represent these.
type Bird = {
  fly: () => void;
};
...
// TODO: Define a type for representing the days of week. Valid values are “Monday”, “Tuesday”, etc.
type DayOfWeek =
  | "Monday"
  | "Tuesday"
  | "Wednesday"
...
// TODO: Simplify the following code snippets:
let user = getUser();
console.log(user?.address?.street);

let x = foo ?? bar();

// TODO: What is the problem in this piece of code?
let value: unknown = "a"; // unkown type
